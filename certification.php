...
<body>
	<div class="container">
		...
		<main>
			<div class="back">
				...
				<div class="lower_heading">
					<a href="qualification.php">Skills</a>
					<a href="education.php">Educations</a>
					<a class="active_link" href="certification.php">Certifucations</a>
					<a href="language.php">Languages</a>
				</div>
				</div>
				<br>
				
				<button id="button" style="background-color:#7fd3cb; padding: 5px;  font-size: 20px; ">ADD+</button>
		...
		<h2 style="color: blue">Certification</h2>			
		<div class="table">
			<?php
