	...
	<div class="container">
		...
		<main>
			<div class="back">
				...
				<div class="lower_heading">
					<a class="active_link" href="training.php">Course</a>
		...
		<form class="navbar-form" method="post" name="form1">
			...
			<input style="width: 200px;"  type="text" name="search" placeholder="Search Company..." required="">
				...
				<button style="background-color:#7fd3cb; width: 35px; height: 35px; " type="submit" name="submit">
		...
		<div class="table">
			<?php
					...
					$q=mysqli_query($db, "SELECT * FROM course");
					...
					echo "<tr style='background-color: #9ac5da;'>";
						...
						echo "<th>"; echo "Co-ordination"; echo "</th>";
						echo "<th>"; echo "Trainer"; echo "</th>";
						echo "<th>"; echo "Trainer"; echo "</th>";
					...
					while($row=mysqli_fetch_assoc($q))
					{
						...
						echo "<tr>";
							...
							echo "<td>"; echo $row['coordinator']; echo "</td>";
