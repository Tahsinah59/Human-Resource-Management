...
<?php
			...
			mysqli_query($db,"INSERT INTO `company_structure` VALUES( '$_POST[name]','$_POST[address]','$_POST[type]','$_POST[phone]','$_POST[pabx]','$_POST[fax]','$_POST[email]');");
				}
...
<!---------------------pop-up Add+-------------end----->
		...
		<div class="table">
				...
				if(isset($_POST['submit1'])){
					mysqli_query($db,"DELETE FROM company_structure WHERE name='$_POST[name]';");
				}
