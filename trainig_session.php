	...
	<div class="container">
		...
		<main>
			<div class="back">
				...
				<div class="lower_heading">
					...
					<a  class="active_link" href="trainig_session.php">Training Session</a>
					<a  href="employee_trainingsession.php">Employee Training Session</a>
		...
		<div class="table">
			<?php
					...
					$q=mysqli_query($db, "SELECT * FROM taining_session");
					...
					echo "<tr style='background-color: #9ac5da;'>";
						...
						echo "<th>"; echo "Schedule time"; echo "</th>";
						echo "<th>"; echo "Status"; echo "</th>";
						echo "<th>"; echo "Deliver Method"; echo "</th>";
						echo "<th>"; echo "Delivery Location"; echo "</th>";
						echo "<th>"; echo "Attendence Type"; echo "</th>";
						echo "<th>"; echo "Training Certificate"; echo "</th>";
					...
					while($row=mysqli_fetch_assoc($q))
					{
						...
						echo "<tr>";
							...
							echo "<td>"; echo $row['scheduletime']; echo "</td>";
							echo "<td>"; echo $row['status']; echo "</td>";
							echo "<td>"; echo $row['delivermethod']; echo "</td>";
							echo "<td>"; echo $row['deliverylocation']; echo "</td>";
							echo "<td>"; echo $row['attendencetype']; echo "</td>";
							echo "<td>"; echo $row['trainingsertificate']; echo "</td>";
							
							?>
					
							<td>
								<button style="background-color: mediumseagreen; padding: 5px;" type="button" class="btn btn-success">EDIT</button>
							</td>
							<td>
