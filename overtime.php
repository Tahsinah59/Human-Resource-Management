	...
	<div class="bg-modal">
		<div class="modal-content">
			...
			<form action="" method="POST">
				...
				<input class="rightinput" type="text" name="employee_id" placeholder="Employee ID"><br><br>
				<input class="rightinput" type="text" name="employee_name" placeholder="Employee_name"><br><br>
				<input class="rightinput" type="text" name="catagory" placeholder="Catagory"><br><br>
				<input class="rightinput" type="text" name="overtime" placeholder="Overtime"><br><br>
...
<?php
			...
			mysqli_query($db,"INSERT INTO `overtime` VALUES( '$_POST[employee_id]','$_POST[employee_name]','$_POST[catagory]','$_POST[overtime]');");
				}
...
<!---------------------pop-up Add+-------------end----->
		...
		<form class="navbar-form" method="post" name="form1">
			...
			<input class="form-control" style="width:200px; height: 10px"; type="text" name="search" placeholder="Search Company..." required="">
		...
		<form class="navbar-form" method="post" name="form1">
			...
			<input class="form-control" style="width:200px; height: 10px"; type="text" name="employee_id" placeholder="Enter Company Name..." required="">
		...
		<div class="table">
				...
				<?php
				$q=mysqli_query($db, "SELECT * FROM overtime");
					...
					while($row=mysqli_fetch_assoc($q))
					{
						...
						echo "<tr>";
							...
							echo "<td>"; echo $row['overtime']; echo "</td>";
				...
				if(isset($_POST['submit1'])){
					mysqli_query($db,"DELETE FROM overtime WHERE employee_id='$_POST[employee_id]';");
				}
