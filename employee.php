	...
	<div class="bg-modal">
		<div class="modal-content">
			...
			<form action="" method="POST">
				...
				<input class="rightinput" type="text" name="id" placeholder="ID"><br><br>
				<input class="rightinput" type="text" name="first" placeholder="First Name"><br><br>
				<input class="rightinput" type="text" name="last" placeholder="Last Name"><br><br>
				<input class="rightinput" type="text" name="password" placeholder="Password"><br><br>
				<input class="rightinput" type="text" name="email" placeholder="Email"><br><br>
				<input class="rightinput" type="text" name="contact" placeholder="Contact"><br><br>
...
<?php
			...
			mysqli_query($db,"INSERT INTO `employee` VALUES( '$_POST[name]','$_POST[id]','$_POST[first]','$_POST[last]','$_POST[password]','$_POST[email]','$_POST[contact]');");
				}
...
<!---------------------pop-up Add+-------------end----->
		...
		<div class="table">
				...
				if(isset($_POST['submit1'])){
					mysqli_query($db,"DELETE FROM employee WHERE name='$_POST[name]';");
				}
